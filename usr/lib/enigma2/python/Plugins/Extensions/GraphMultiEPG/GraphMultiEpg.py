...
class EPGList(GUIComponent):
	...
	def setCurrentIndex(self, index):
		if self.instance:
			print("[EPG] moving to index: " + str(index))
			self.instance.moveSelectionTo(index)

	def moveTo(self, dir):
		if self.instance:
			print("[EPG] moving selection ")
...
class GraphMultiEPG(Screen, HelpableScreen):
	...
	def onCreate(self):
		...
		print("[EPG] currref: " + self.previousref.toString())
